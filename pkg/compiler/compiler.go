...
func (c *Context) compileForm(o vm.Value) error {
	...
	switch o.Type() {
	case vm.IntType, vm.FloatType, vm.StringType, vm.NilType, vm.BooleanType, vm.KeywordType, vm.CharType, vm.VoidType, vm.FuncType, vm.BigIntType, vm.RatioType, vm.BigDecimalType:
		n := c.constant(o)
		c.emitWithArg(vm.OP_LOAD_CONST, n)
		c.incSP(1)
	case vm.SymbolType:
