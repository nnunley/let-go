...
// gogen.nsHash:       b7afe1744b61904f6741b762f1a6c066b7242372d9fd8ce94230491a56862c77
...
func intersect(idom_0 vm.Value, rpo_idx_1 vm.Value, b1_2 vm.Value, b2_3 vm.Value) (vm.Value, error) {
	var b1_5 vm.Value
	var b2_6 vm.Value
	var b2_7 vm.Value
	var b1_8 vm.Value
	...
	var arg__15953_32 vm.Value
	var arg__15959_34 vm.Value
	var v35 bool
	var v88 vm.Value
	var b2_89 vm.Value
	var b1_90 vm.Value
	...
	var arg__15970_49 vm.Value
	var arg__15976_51 vm.Value
	var v52 bool
	var v82 vm.Value
	var b2_83 vm.Value
	var b1_84 vm.Value
	...
	var callErr error
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = b1_5, b2_6, b2_7, b1_8, rpo_idx_9, idom_10, v20, b2_12, b1_13, rpo_idx_14, idom_15, b2_16, b1_17, rpo_idx_18, idom_19, arg__15953_32, arg__15959_34, v35, v88, b2_89, b1_90, rpo_idx_91, idom_92, b2_23, b1_24, rpo_idx_25, idom_26, v38, b2_27, b1_28, rpo_idx_29, idom_30, arg__15970_49, arg__15976_51, v52, v82, b2_83, b1_84, rpo_idx_85, idom_86, b2_40, b1_41, rpo_idx_42, idom_43, v55, b2_44, b1_45, rpo_idx_46, idom_47, v76, b2_77, b1_78, rpo_idx_79, idom_80, b2_57, b1_58, rpo_idx_59, idom_60, b2_61, b1_62, rpo_idx_63, idom_64, v70, b2_71, b1_72, rpo_idx_73, idom_74
	b1_5 = b1_2
	b2_6 = b2_3
	b2_7 = b2_3
	b1_8 = b1_2
...
b3:
	;
	arg__15953_32, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "nth").Deref(), []vm.Value{rpo_idx_18, b1_17})
	if callErr != nil {
		return nil, callErr
	}
	arg__15959_34, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "nth").Deref(), []vm.Value{rpo_idx_18, b2_16})
	if callErr != nil {
		return nil, callErr
	}
	v35 = rt.GtValue(arg__15953_32, arg__15959_34)
	if v35 {
		b2_23 = b2_16
		b1_24 = b1_17
...
b6:
	;
	arg__15970_49, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "nth").Deref(), []vm.Value{rpo_idx_29, b2_27})
	if callErr != nil {
		return nil, callErr
	}
	arg__15976_51, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "nth").Deref(), []vm.Value{rpo_idx_29, b1_28})
	if callErr != nil {
		return nil, callErr
	}
	v52 = rt.GtValue(arg__15970_49, arg__15976_51)
	if v52 {
		b2_40 = b2_27
		b1_41 = b1_28
...
func successors(f_0 vm.Value, bid_1 vm.Value) (vm.Value, error) {
	var term_4 vm.Value
	var op_6 vm.Value
	var aux_8 vm.Value
	var v20 bool
	...
	var t_41 vm.Value
	var e_43 vm.Value
	var arg__16016_46 vm.Value
	var arg__16020_48 vm.Value
	var v49 vm.Value
	var f_32 vm.Value
	var bid_33 vm.Value
	...
	var aux_72 vm.Value
	var callErr error
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = term_4, op_6, aux_8, v20, f_9, bid_10, term_11, op_12, aux_13, arg__16003_24, v25, f_14, bid_15, term_16, op_17, aux_18, v38, v81, f_82, bid_83, term_84, op_85, aux_86, f_27, bid_28, term_29, op_30, aux_31, t_41, e_43, arg__16016_46, arg__16020_48, v49, f_32, bid_33, term_34, op_35, aux_36, v74, f_75, bid_76, term_77, op_78, aux_79, f_51, bid_52, term_53, op_54, aux_55, f_56, bid_57, term_58, op_59, aux_60, v67, f_68, bid_69, term_70, op_71, aux_72
	term_4, callErr = rt.InvokeValue(rt.LookupVar("ir", "block-term").Deref(), []vm.Value{bid_1, f_0})
	if callErr != nil {
		return nil, callErr
	}
	...
	aux_8, callErr = rt.InvokeValue(rt.LookupVar("ir", "aux").Deref(), []vm.Value{term_4, f_0})
	if callErr != nil {
		return nil, callErr
	}
	v20 = rt.EqValue(op_6, vm.Keyword("branch"))
	if v20 {
		f_9 = f_0
		bid_10 = bid_1
		term_11 = term_4
...
b1:
	;
	arg__16003_24, callErr = rt.InvokeValue(rt.LookupVar("ir", "branch-target-target").Deref(), []vm.Value{aux_13})
	if callErr != nil {
		return nil, callErr
	}
	v25, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "vector").Deref(), []vm.Value{arg__16003_24})
	if callErr != nil {
		return nil, callErr
	}
	v81 = v25
...
b2:
	;
	v38 = rt.EqValue(op_17, vm.Keyword("branch-if"))
	if v38 {
		f_27 = f_14
		bid_28 = bid_15
		term_29 = term_16
...
b4:
	...
	arg__16016_46, callErr = rt.InvokeValue(rt.LookupVar("ir", "branch-target-target").Deref(), []vm.Value{t_41})
	if callErr != nil {
		return nil, callErr
	}
	arg__16020_48, callErr = rt.InvokeValue(rt.LookupVar("ir", "branch-target-target").Deref(), []vm.Value{e_43})
	if callErr != nil {
		return nil, callErr
	}
	v49, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "vector").Deref(), []vm.Value{arg__16016_46, arg__16020_48})
	if callErr != nil {
		return nil, callErr
	}
	v74 = v49
...
func dfs_postorder(f_0 vm.Value, entry_1 vm.Value) (vm.Value, error) {
	var arg__16029_10 vm.Value
	var arg__16031_12 vm.Value
	var v13 vm.Value
	var v15 vm.Value
	...
	var si_54 vm.Value
	var s_69 vm.Value
	var arg__16070_71 vm.Value
	var arg__16076_74 vm.Value
	var arg__16077_75 vm.Value
	var arg__16083_78 vm.Value
	var arg__16084_79 vm.Value
	var arg__16090_82 vm.Value
	...
	var arg__16104_112 vm.Value
	var arg__16106_114 vm.Value
	var arg__16116_118 vm.Value
	var arg__16118_120 vm.Value
	var v121 vm.Value
	var v123 vm.Value
	var callErr error
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = arg__16029_10, arg__16031_12, v13, v15, stack_3, visited_4, post_5, f_6, v29, entry_18, stack_19, visited_20, post_21, f_22, entry_23, stack_24, visited_25, post_26, f_27, top_33, bid_37, succs_41, si_45, arg__16060_65, v66, v130, entry_131, stack_132, visited_133, post_134, f_135, entry_46, stack_47, visited_48, post_49, f_50, top_51, bid_52, succs_53, si_54, s_69, arg__16070_71, arg__16076_74, arg__16077_75, arg__16083_78, arg__16084_79, arg__16090_82, stack_PRIME__83, v107, entry_55, stack_56, visited_57, post_58, f_59, top_60, bid_61, succs_62, si_63, v126, v128, entry_84, stack_85, visited_86, post_87, f_88, top_89, bid_90, succs_91, si_92, s_93, stack_PRIME__94, entry_95, stack_96, visited_97, post_98, f_99, top_100, bid_101, succs_102, si_103, s_104, stack_PRIME__105, arg__16104_112, arg__16106_114, arg__16116_118, arg__16118_120, v121, v123
	arg__16029_10, callErr = rt.InvokeValue(rt.LookupVar("ir.dominance", "successors").Deref(), []vm.Value{f_0, entry_1})
	if callErr != nil {
		return nil, callErr
	}
	arg__16031_12, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "vector").Deref(), []vm.Value{entry_1, arg__16029_10, vm.Int(0)})
	if callErr != nil {
		return nil, callErr
	}
	v13, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "vector").Deref(), []vm.Value{arg__16031_12})
	if callErr != nil {
		return nil, callErr
	}
	v15, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "hash-set").Deref(), []vm.Value{entry_1})
	if callErr != nil {
		return nil, callErr
	}
	stack_3 = v13
...
b3:
	...
	arg__16060_65, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "count").Deref(), []vm.Value{succs_41})
	if callErr != nil {
		return nil, callErr
	}
	v66 = rt.LtValue(si_45, arg__16060_65)
	if v66 {
		entry_46 = entry_23
		stack_47 = stack_24
...
b5:
	...
	arg__16070_71, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "count").Deref(), []vm.Value{stack_47})
	if callErr != nil {
		return nil, callErr
	}
	arg__16076_74 = rt.AddValue(si_54, vm.Int(1))
	arg__16077_75, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "vector").Deref(), []vm.Value{bid_52, succs_53, arg__16076_74})
	if callErr != nil {
		return nil, callErr
	}
	arg__16083_78, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "count").Deref(), []vm.Value{stack_47})
	if callErr != nil {
		return nil, callErr
	}
	arg__16084_79 = rt.SubValue(arg__16083_78, vm.Int(1))
	arg__16090_82, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "vector").Deref(), []vm.Value{bid_52, succs_53, arg__16076_74})
	if callErr != nil {
		return nil, callErr
	}
	stack_PRIME__83, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "assoc").Deref(), []vm.Value{stack_47, arg__16084_79, arg__16090_82})
	if callErr != nil {
		return nil, callErr
	}
...
b9:
	;
	arg__16104_112, callErr = rt.InvokeValue(rt.LookupVar("ir.dominance", "successors").Deref(), []vm.Value{f_99, s_104})
	if callErr != nil {
		return nil, callErr
	}
	arg__16106_114, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "vector").Deref(), []vm.Value{s_104, arg__16104_112, vm.Int(0)})
	if callErr != nil {
		return nil, callErr
	}
	arg__16116_118, callErr = rt.InvokeValue(rt.LookupVar("ir.dominance", "successors").Deref(), []vm.Value{f_99, s_104})
	if callErr != nil {
		return nil, callErr
	}
	arg__16118_120, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "vector").Deref(), []vm.Value{s_104, arg__16116_118, vm.Int(0)})
	if callErr != nil {
		return nil, callErr
	}
	v121, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "conj").Deref(), []vm.Value{stack_PRIME__105, arg__16118_120})
	if callErr != nil {
		return nil, callErr
	}
...
func reverse_postorder(f_0 vm.Value) (vm.Value, error) {
	var arg__16136_3 vm.Value
	var arg__16142_6 vm.Value
	var arg__16143_7 vm.Value
	var arg__16149_10 vm.Value
	var arg__16155_13 vm.Value
	var arg__16156_14 vm.Value
	var arg__16157_15 vm.Value
	var arg__16163_18 vm.Value
	var arg__16169_21 vm.Value
	var arg__16170_22 vm.Value
	var arg__16176_25 vm.Value
	var arg__16182_28 vm.Value
	var arg__16183_29 vm.Value
	var arg__16184_30 vm.Value
	var v31 vm.Value
	var callErr error
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = arg__16136_3, arg__16142_6, arg__16143_7, arg__16149_10, arg__16155_13, arg__16156_14, arg__16157_15, arg__16163_18, arg__16169_21, arg__16170_22, arg__16176_25, arg__16182_28, arg__16183_29, arg__16184_30, v31
	arg__16136_3, callErr = rt.InvokeValue(rt.LookupVar("ir", "fn-entry").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	arg__16142_6, callErr = rt.InvokeValue(rt.LookupVar("ir", "fn-entry").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	arg__16143_7, callErr = rt.InvokeValue(rt.LookupVar("ir.dominance", "dfs-postorder").Deref(), []vm.Value{f_0, arg__16142_6})
	if callErr != nil {
		return nil, callErr
	}
	arg__16149_10, callErr = rt.InvokeValue(rt.LookupVar("ir", "fn-entry").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	arg__16155_13, callErr = rt.InvokeValue(rt.LookupVar("ir", "fn-entry").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	arg__16156_14, callErr = rt.InvokeValue(rt.LookupVar("ir.dominance", "dfs-postorder").Deref(), []vm.Value{f_0, arg__16155_13})
	if callErr != nil {
		return nil, callErr
	}
	arg__16157_15, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "reverse").Deref(), []vm.Value{arg__16156_14})
	if callErr != nil {
		return nil, callErr
	}
	arg__16163_18, callErr = rt.InvokeValue(rt.LookupVar("ir", "fn-entry").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	arg__16169_21, callErr = rt.InvokeValue(rt.LookupVar("ir", "fn-entry").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	arg__16170_22, callErr = rt.InvokeValue(rt.LookupVar("ir.dominance", "dfs-postorder").Deref(), []vm.Value{f_0, arg__16169_21})
	if callErr != nil {
		return nil, callErr
	}
	arg__16176_25, callErr = rt.InvokeValue(rt.LookupVar("ir", "fn-entry").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	arg__16182_28, callErr = rt.InvokeValue(rt.LookupVar("ir", "fn-entry").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	arg__16183_29, callErr = rt.InvokeValue(rt.LookupVar("ir.dominance", "dfs-postorder").Deref(), []vm.Value{f_0, arg__16182_28})
	if callErr != nil {
		return nil, callErr
	}
	arg__16184_30, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "reverse").Deref(), []vm.Value{arg__16183_29})
	if callErr != nil {
		return nil, callErr
	}
	v31, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "vec").Deref(), []vm.Value{arg__16184_30})
	if callErr != nil {
		return nil, callErr
	}
	return v31, nil
}
func refine_idom(f_0 vm.Value, bid_1 vm.Value, idom_2 vm.Value, rpo_idx_3 vm.Value) (vm.Value, error) {
...
b3:
	...
	arg__16202_51, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "nth").Deref(), []vm.Value{idom_26, p_32})
	if callErr != nil {
		return nil, callErr
	}
	v52 = rt.EqValue(arg__16202_51, vm.Int(-1))
	if v52 {
		f_33 = f_20
		bid_34 = bid_21
		preds_35 = preds_22
...
b6:
	;
	v74 = rt.EqValue(new_id_45, vm.Int(-1))
	if v74 {
		f_57 = f_41
		bid_58 = bid_42
		preds_59 = preds_43
...
func dominators(f_0 vm.Value) (vm.Value, error) {
	var arg__16226_3 vm.Value
	var arg__16231_6 vm.Value
	var n_7 vm.Value
	var entry_9 vm.Value
	var rpo_11 vm.Value
	var arg__16243_19 vm.Value
	var arg__16250_24 vm.Value
	var v25 vm.Value
	var i_12 int
	var idx_13 vm.Value
	var rpo_14 vm.Value
	var arg__16255_40 vm.Value
	var v41 bool
	var f_27 vm.Value
	var n_28 vm.Value
	...
	var rpo_38 vm.Value
	var v44 int
	var arg__16263_46 vm.Value
	var arg__16272_49 vm.Value
	var v50 vm.Value
	...
	var idx_57 vm.Value
	var rpo_58 vm.Value
	var arg__16279_62 vm.Value
	var arg__16286_67 vm.Value
	var arg__16287_68 vm.Value
	var arg__16296_73 vm.Value
	var arg__16303_78 vm.Value
	var arg__16304_79 vm.Value
	...
	var v311 vm.Value
	var callErr error
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = arg__16226_3, arg__16231_6, n_7, entry_9, rpo_11, arg__16243_19, arg__16250_24, v25, i_12, idx_13, rpo_14, arg__16255_40, v41, f_27, n_28, entry_29, i_30, idx_31, rpo_32, f_33, n_34, entry_35, i_36, idx_37, rpo_38, v44, arg__16263_46, arg__16272_49, v50, rpo_idx_52, f_53, n_54, entry_55, i_56, idx_57, rpo_58, arg__16279_62, arg__16286_67, arg__16287_68, arg__16296_73, arg__16303_78, arg__16304_79, idom0_80, idom_81, rpo_idx_82, rpo_83, f_84, entry_85, v327, v341, v355, bs_87, idom_88, changed_QMARK__89, rpo_idx_90, idom_91, f_92, entry_93, v325, v339, v353, v119, n_96, i_97, idx_98, idom0_99, rpo_100, bs_101, changed_QMARK__102, rpo_idx_103, idom_104, f_105, entry_106, v332, v346, v360, v122, n_107, i_108, idx_109, idom0_110, rpo_111, bs_112, changed_QMARK__113, rpo_idx_114, idom_115, f_116, entry_117, v323, v337, v351, b_125, v150, step_244, n_245, i_246, idx_247, idom0_248, rpo_249, bs_250, changed_QMARK__251, rpo_idx_252, idom_253, f_254, entry_255, v328, v342, v356, v283, n_126, i_127, idx_128, idom0_129, rpo_130, bs_131, changed_QMARK__132, rpo_idx_133, idom_134, f_135, entry_136, b_137, v324, v338, v352, v153, n_138, i_139, idx_140, idom0_141, rpo_142, bs_143, changed_QMARK__144, rpo_idx_145, idom_146, f_147, entry_148, b_149, v321, v335, v349, ni_156, or__x_184, n_157, i_158, idx_159, idom0_160, rpo_161, bs_162, changed_QMARK__163, rpo_idx_164, idom_165, f_166, entry_167, b_168, ni_169, v322, v336, v350, v236, n_170, i_171, idx_172, idom0_173, rpo_174, bs_175, changed_QMARK__176, rpo_idx_177, idom_178, f_179, entry_180, b_181, ni_182, v331, v345, v359, v239, v241, n_185, i_186, idx_187, idom0_188, rpo_189, bs_190, changed_QMARK__191, rpo_idx_192, idom_193, f_194, entry_195, b_196, ni_197, or__x_198, v320, v334, v348, n_199, i_200, idx_201, idom0_202, rpo_203, bs_204, changed_QMARK__205, rpo_idx_206, idom_207, f_208, entry_209, b_210, ni_211, or__x_212, v329, v343, v357, arg__16337_216, v217, v219, n_220, i_221, idx_222, idom0_223, rpo_224, bs_225, changed_QMARK__226, rpo_idx_227, idom_228, f_229, entry_230, b_231, ni_232, or__x_233, v326, v340, v354, step_256, n_257, i_258, idx_259, idom0_260, rpo_261, bs_262, changed_QMARK__263, rpo_idx_264, idom_265, f_266, entry_267, v330, v344, v358, v288, step_268, n_269, i_270, idx_271, idom0_272, rpo_273, bs_274, changed_QMARK__275, rpo_idx_276, idom_277, f_278, entry_279, v333, v347, v361, v293, final_295, step_296, n_297, i_298, idx_299, idom0_300, rpo_301, bs_302, changed_QMARK__303, rpo_idx_304, idom_305, f_306, entry_307, v311
	arg__16226_3, callErr = rt.InvokeValue(rt.LookupVar("ir", "blocks").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	arg__16231_6, callErr = rt.InvokeValue(rt.LookupVar("ir", "blocks").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	n_7, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "count").Deref(), []vm.Value{arg__16231_6})
	if callErr != nil {
		return nil, callErr
	}
	entry_9, callErr = rt.InvokeValue(rt.LookupVar("ir", "fn-entry").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	rpo_11, callErr = rt.InvokeValue(rt.LookupVar("ir.dominance", "reverse-postorder").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	arg__16243_19, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "repeat").Deref(), []vm.Value{n_7, vm.Int(-1)})
	if callErr != nil {
		return nil, callErr
	}
	arg__16250_24, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "repeat").Deref(), []vm.Value{n_7, vm.Int(-1)})
	if callErr != nil {
		return nil, callErr
	}
	v25, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "vec").Deref(), []vm.Value{arg__16250_24})
	if callErr != nil {
		return nil, callErr
	}
	i_12 = 0
...
b1:
	;
	arg__16255_40, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "count").Deref(), []vm.Value{rpo_14})
	if callErr != nil {
		return nil, callErr
	}
	v41 = rt.GeValue(vm.Int(i_12), arg__16255_40)
	if v41 {
		f_27 = f_0
		n_28 = n_7
		entry_29 = entry_9
...
b3:
	;
	v44 = i_36 + 1
	arg__16263_46, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "nth").Deref(), []vm.Value{rpo_38, vm.Int(i_36)})
	if callErr != nil {
		return nil, callErr
	}
	arg__16272_49, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "nth").Deref(), []vm.Value{rpo_38, vm.Int(i_36)})
	if callErr != nil {
		return nil, callErr
	}
	v50, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "assoc").Deref(), []vm.Value{idx_37, arg__16272_49, vm.Int(i_36)})
	if callErr != nil {
		return nil, callErr
	}
	i_12 = v44
...
b4:
	;
	arg__16279_62, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "repeat").Deref(), []vm.Value{n_54, vm.Int(-1)})
	if callErr != nil {
		return nil, callErr
	}
	arg__16286_67, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "repeat").Deref(), []vm.Value{n_54, vm.Int(-1)})
	if callErr != nil {
		return nil, callErr
	}
	arg__16287_68, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "vec").Deref(), []vm.Value{arg__16286_67})
	if callErr != nil {
		return nil, callErr
	}
	arg__16296_73, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "repeat").Deref(), []vm.Value{n_54, vm.Int(-1)})
	if callErr != nil {
		return nil, callErr
	}
	arg__16303_78, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "repeat").Deref(), []vm.Value{n_54, vm.Int(-1)})
	if callErr != nil {
		return nil, callErr
	}
	arg__16304_79, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "vec").Deref(), []vm.Value{arg__16303_78})
	if callErr != nil {
		return nil, callErr
	}
	idom0_80, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "assoc").Deref(), []vm.Value{arg__16304_79, entry_55, entry_55})
	if callErr != nil {
		return nil, callErr
	}
	idom_81 = idom0_80
...
b8:
	...
	v150 = rt.EqValue(b_125, entry_117)
	if v150 {
		n_126 = n_107
		i_127 = i_108
		idx_128 = idx_109
...
b11:
	...
	or__x_184 = rt.EqValue(ni_156, vm.Int(v321))
	if or__x_184 {
		n_185 = n_138
		i_186 = i_139
		idx_187 = idx_140
...
b17:
	;
	arg__16337_216, callErr = rt.InvokeValue(rt.LookupVar("clojure.core", "nth").Deref(), []vm.Value{idom_207, b_210})
	if callErr != nil {
		return nil, callErr
	}
	v217 = rt.EqValue(arg__16337_216, ni_211)
	v219 = v217
	n_220 = n_199
	i_221 = i_200
	idx_222 = idx_201
...
func dominates_QMARK_(f_0 vm.Value, a_1 vm.Value, b_2 vm.Value) (vm.Value, error) {
	var idom_5 vm.Value
	var b_6 vm.Value
	var idom_7 vm.Value
	var b_8 vm.Value
	...
	idom_5, callErr = rt.InvokeValue(rt.LookupVar("ir.dominance", "dominators").Deref(), []vm.Value{f_0})
	if callErr != nil {
		return nil, callErr
	}
	b_6 = b_2
